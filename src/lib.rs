...
const PROVIDER_ID: &str = "timescale_compression-composed";
...
fn scalar_name_by_arm_idx(arm: usize) -> Option<&'static str> {
    match arm as u32 {
        0 => Some("chunk_rewrite_cleanup"),
        1 => Some("compact_chunk"),
        2 => Some("compress_chunk"),
        3 => Some("convert_to_columnstore"),
        4 => Some("convert_to_rowstore"),
        5 => Some("create_compressed_chunk"),
        6 => Some("decompress_chunk"),
        7 => Some("get_compressed_chunk_index_for_recompression"),
        8 => Some("get_orderby_defaults"),
        9 => Some("get_segmentby_defaults"),
        10 => Some("rebuild_columnstore"),
        11 => Some("rebuild_sparse_index"),
        12 => Some("recompress_chunk"),
        13 => Some("recompress_chunk_segmentwise"),
        _ => None,
    }
}
...
fn register_scalars() -> Result<(), Duckerror> {
    ...
    };
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("chunk_rewrite_cleanup (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["chunk_rewrite_cleanup".into()],
    ...
    }
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("compact_chunk (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["compact_chunk".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
            "compact_chunk",
    ...
    }
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("compress_chunk (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["compress_chunk".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
            "compress_chunk",
    ...
    }
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("convert_to_columnstore (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["convert_to_columnstore".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
    ...
    }
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("convert_to_rowstore (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["convert_to_rowstore".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
            "convert_to_rowstore",
    ...
    }
    {
        ...
        let args: Vec<runtime::Funcarg> = vec![
                ...
                runtime::Funcarg { name: Some("arg1".into()), logical: Logicaltype::Blob },
                runtime::Funcarg { name: Some("arg2".into()), logical: Logicaltype::Blob },
                runtime::Funcarg { name: Some("arg3".into()), logical: Logicaltype::Blob },
                runtime::Funcarg { name: Some("arg4".into()), logical: Logicaltype::Blob },
                runtime::Funcarg { name: Some("arg5".into()), logical: Logicaltype::Blob },
                runtime::Funcarg { name: Some("arg6".into()), logical: Logicaltype::Blob },
                runtime::Funcarg { name: Some("arg7".into()), logical: Logicaltype::Blob },
                runtime::Funcarg { name: Some("arg8".into()), logical: Logicaltype::Blob },
                runtime::Funcarg { name: Some("arg9".into()), logical: Logicaltype::Blob },
            ];
        let opts = runtime::Funcopts {
            description: Some("create_compressed_chunk (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["create_compressed_chunk".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
    ...
    }
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("decompress_chunk (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["decompress_chunk".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
            "decompress_chunk",
    ...
    }
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("get_compressed_chunk_index_for_recompression (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["get_compressed_chunk_index_for_recompression".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
    ...
    }
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("get_orderby_defaults (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["get_orderby_defaults".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
    ...
    }
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("get_segmentby_defaults (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["get_segmentby_defaults".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
    ...
    }
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("rebuild_columnstore (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["rebuild_columnstore".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
            "rebuild_columnstore",
    ...
    }
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("rebuild_sparse_index (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["rebuild_sparse_index".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
    ...
    }
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("recompress_chunk (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["recompress_chunk".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
            "recompress_chunk",
    ...
    }
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("recompress_chunk_segmentwise (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["recompress_chunk_segmentwise".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
...
fn register_aggregates() -> Result<(), Duckerror> {
    ...
    let Some(capability) = runtime::get_capability(Capabilitykind::Aggregate) else {
        if false {
            eprintln!("[dynlink-emit] host did not expose aggregate capability; skipping 0 aggregate(s)");
        }
        return Ok(());
    };
    let registry = match capability {
